...
hooks.Filters.ENV_PATTERNS_INCLUDE.add_items(
    [
        ...
        r"nla-theme/cms/static/sass/partials/cms/theme/",
    ]
)
...
with open(
    os.path.join(
        str(importlib_resources.files("nlatheme") / "templates"),
        "nla-theme",
        "tasks",
        "init.sh",
    ),
...
hooks.Filters.ENV_PATCHES.add_items(
    [
        (
            ...
            """
RUN npm install '@edx/brand@git+https://github.com/newliteraciesalliance/brand-nla.git@^nla-redwood'{% if INDIGO_ENABLE_DARK_THEME %} --theme=dark{% endif %}
...
dark_theme_filepath = ['nla-theme/js/dark-theme.js']
